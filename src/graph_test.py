...
class TestGraphMethods(unittest.TestCase):
    ...
    def test_shortestPath(self):
        ...
        self.assertEqual(
            paths, [[
                284128874, 348743344, 441779558, 472376334, 212423022,
                285085950, 642091211, 974539967, 399282125, 306383333,
                442669090, 976159883, 898434317, 499396400, 127244232,
                68512376, 279306298, 113519422, 445675124, 656315998
            ],
                    [
                        284128874, 312599411, 503330672, 100910111, 971626851,
                        290879796, 493241495, 470468420, 328134176, 537303321,
                        925335830, 285091748, 697076048, 457067861, 607654729,
                        231429954, 217007096, 48294070, 976687434, 866669992,
                        866668421, 893413132, 922368199, 383343989, 903603992,
                        122338873, 277945345, 656315998
                    ]])
